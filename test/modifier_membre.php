...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['nom'])) {
    ...
    if ($conn->query($updateSql) === TRUE) {
        ...
        echo "Une erreur s'est produite lors de l'enregistrement des modifications : " . $conn->error;
                    ...
                    if (!empty($photoName)) {
                    echo '<label for="current_photo">Photo actuelle :</label><br>';
                    echo '<img src="photo/' . $photoName . '" width="150"><br>';
                    echo '<input type="hidden" name="current_photo" value="' . $photoName . '">';
                    }
